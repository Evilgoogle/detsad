...
<div class="header">Добавление объявления</span></div>
<div class="content">
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="table_block_title">
      ...
      <input type="text" name="title" class="table_block_title_text" value="<?php echo @hc($_POST['title']);?>">
    </div>
    <div class="table_block_title_error">
      <?php if(isset($error['title'])) {?>
        <div class="table_block_title_error_text"><?php echo $error['title'];?></div>
      <?php } else {?>
        <div class="table_block_title_info_text">Введите названия записи</div>
      <?php } ?>
    </div>
    <div class="claer"></div>
    ...
    <div class="table_block_text">
      ...
      <textarea id="editor_text" name="text" class="new_add_blockn_des"><?php echo @$_POST['text'];?></textarea>
      <script>
    ...
    <div class="table_block_title_error">
      ...
      <?php } else {?>
        <div class="table_block_title_info_text">Минимальный размер 270x170px(ширина-высота). Разширение jpeg,jpg,gif,png</div>
      <?php } ?>
    </div>
    <div class="claer"></div>

    <div class="table_block_button">
      <input type="submit" name="ok" class="button_form" value="Добавить">
    </div>
  </form>
